...
namespace Hooks
{
    ...
    inline static REL::Relocation<std::uintptr_t> Player_Update_Hook{ REL::RelocationID(35565, 36564), REL::Relocate(0x1E, 0x6E) };
    inline static REL::Relocation<std::uintptr_t> Actor_Update_Hook{ REL::RelocationID(36357, 37348), REL::Relocate(0x6D3, 0x674) };
